About apache-airflow-providers-cncf-kubernetes-feedstock
========================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/apache-airflow-providers-cncf-kubernetes-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/apache-airflow-providers-cncf-kubernetes-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add apache-airflow-providers-cncf-kubernetes
# for installing globally
pixi global install apache-airflow-providers-cncf-kubernetes
```
...
It is possible to list all of the versions of `apache-airflow-providers-cncf-kubernetes` available on your platform:
...
```
pixi search apache-airflow-providers-cncf-kubernetes --channel conda-forge
```
